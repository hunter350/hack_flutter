...
Data _$DataFromJson(Map<String, dynamic> json) {
  return Data(
    ...
    nextMeetings: (json['next_meetings'] as List)
        ?.map((e) =>
            e == null ? null : NextMeetings.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
Map<String, dynamic> _$DataToJson(Data instance) => <String, dynamic>{
      ...
      'next_meetings': instance.nextMeetings,
    };
...
NextMeetings _$NextMeetingsFromJson(Map<String, dynamic> json) {
  return NextMeetings(
    sportEvent: json['sport_event'] == null
        ? null
        : SportEvent.fromJson(json['sport_event'] as Map<String, dynamic>),
...
Map<String, dynamic> _$NextMeetingsToJson(NextMeetings instance) =>
    <String, dynamic>{
      'sport_event': instance.sportEvent,
    };
